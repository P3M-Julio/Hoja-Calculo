...
public class vmmMenuPanel extends panelBase {
	private JTextField[] fields = new JTextField[2];
	
	public vmmMenuPanel(Dimension size) {
		super(size);
	...
	protected void draw() {
		...
		g.setFont(new Font(this.getFont().getName(), 0, 10));
		g.drawString("Vuelva a abrir la ventana de opciones para refrescar", 15, 155);
	}
